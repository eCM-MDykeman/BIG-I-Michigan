$(function () {
    var username = $('.member-dashboard-name .ProfileUserName span'),
        ...
        progressBar = "",
        progressText = "",
        collapsedGreeting = !!($('.member-dashboard-name').html()) ? '<div class="collapsed-greeting"><div>Welcome back, </div><a href="profile">' + username.text() + '</a></div>' : '<div class="collapsed-greeting"><div>Welcome to Big I Michigan</div></div>';
    ...
    $('.getting-started, .second-column').wrapAll('<div class="dashboard-col-2 col-md-3" />');
    $('.make-buttons.getting-started, .make-buttons.second-column').wrapAll('<div class="dashboard-btns" />');
